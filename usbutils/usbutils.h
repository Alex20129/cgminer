...
#define FTDI_REQUEST_RESET ((u_int8_t)0)
#define FTDI_REQUEST_MODEM ((u_int8_t)1)
#define FTDI_REQUEST_FLOW ((u_int8_t)2)
#define FTDI_REQUEST_BAUD ((u_int8_t)3)
#define FTDI_REQUEST_DATA ((u_int8_t)4)
#define FTDI_REQUEST_LATENCY ((u_int8_t)9)
...
struct cg_usb_info {
	...
	u_int32_t ioerr_count;
	u_int32_t continuous_ioerr_count;
...
int _usb_transfer(struct cgpu_info *cgpu, u_int8_t request_type, u_int8_t bRequest, u_int16_t wValue, u_int16_t wIndex, u_int32_t *data, int siz, unsigned int timeout, enum usb_cmds cmd);
int _usb_transfer_read(struct cgpu_info *cgpu, u_int8_t request_type, u_int8_t bRequest, u_int16_t wValue, u_int16_t wIndex, char *buf, int bufsiz, int *amount, unsigned int timeout, enum usb_cmds cmd);
...
u_int32_t usb_buffer_size(struct cgpu_info *cgpu);
