...
#ifndef DRIVER_AVALON_4_H
#define DRIVER_AVALON_4_H
...
struct avalon4_info
{
	...
	u_int16_t set_voltage_i[AVA4_DEFAULT_MODULARS][AVA4_DEFAULT_MINER_MAX];
	...
	u_int8_t mm_dna[AVA4_DEFAULT_MODULARS][AVA4_MM_DNA_LEN + 1];
	...
	u_int16_t adc[AVA4_DEFAULT_MODULARS][AVA4_DEFAULT_ADC_MAX];
	u_int16_t pll_sel[AVA4_DEFAULT_MODULARS][AVA4_DEFAULT_PLL_MAX];
	...
	u_int32_t local_work[AVA4_DEFAULT_MODULARS];
	u_int32_t hw_work[AVA4_DEFAULT_MODULARS];

	u_int32_t lw5[AVA4_DEFAULT_MODULARS][AVA4_DEFAULT_ADJ_TIMES];
	u_int32_t lw5_i[AVA4_DEFAULT_MODULARS][AVA4_DEFAULT_MINER_MAX][AVA4_DEFAULT_ADJ_TIMES];
	u_int32_t hw5[AVA4_DEFAULT_MODULARS][AVA4_DEFAULT_ADJ_TIMES];
	u_int32_t hw5_i[AVA4_DEFAULT_MODULARS][AVA4_DEFAULT_MINER_MAX][AVA4_DEFAULT_ADJ_TIMES];
	int i_5s;
	...
	u_int8_t saved[AVA4_DEFAULT_MODULARS];
	u_int8_t adjflag[AVA4_DEFAULT_MODULARS][AVA4_DEFAULT_MINER_MAX];
	u_int8_t cutoff[AVA4_DEFAULT_MODULARS];
	u_int8_t miner_count[AVA4_DEFAULT_MODULARS];
	u_int8_t asic_count[AVA4_DEFAULT_MODULARS];
	int ntime_offset[AVA4_DEFAULT_MODULARS];
	bool autov[AVA4_DEFAULT_MODULARS];
	u_int8_t ma_sum[AVA4_DEFAULT_MODULARS][AVA4_DEFAULT_MINER_MAX][AVA4_DEFAULT_ASIC_MAX];
	u_int32_t newnonce;
	u_int32_t total_asics[AVA4_DEFAULT_MODULARS];
	int toverheat[AVA4_DEFAULT_MODULARS];
	int temp_target[AVA4_DEFAULT_MODULARS];
	u_int8_t speed_bingo[AVA4_DEFAULT_MODULARS];
	u_int8_t speed_error[AVA4_DEFAULT_MODULARS];
	u_int32_t freq_mode[AVA4_DEFAULT_MODULARS];
