...
static bool i2c_slave_write(struct i2c_ctx *ctx, u_int8_t reg, u_int8_t val)
{
...
static bool i2c_slave_read(struct i2c_ctx *ctx, u_int8_t reg, u_int8_t *val)
{
	union i2c_smbus_data data;
	struct i2c_smbus_ioctl_data args;
...
static bool i2c_slave_write_raw(struct i2c_ctx *ctx, u_int8_t *buf, u_int32_t len)
{
...
static bool i2c_slave_read_raw(struct i2c_ctx *ctx, u_int8_t *buf, u_int32_t len)
{
