...
#ifndef DRIVER_AVALON_8_H
#define DRIVER_AVALON_8_H
...
#define AVA8_INVALID_VOLTAGE_LEVEL	-1
...
#define AVA8_DEFAULT_ASIC_MAX	34
...
#define AVA8_P_STATUS_POWER		0x48
...
#define AVA8_DEFAULT_POWER_INFO_CNT	8
...
struct avalon8_info {
	...
	u_int8_t mm_dna[AVA8_DEFAULT_MODULARS][AVA8_MM_DNA_LEN];
	char mm_version[AVA8_DEFAULT_MODULARS][AVA8_MM_VER_LEN + 1]; /* It's a string */
	u_int32_t total_asics[AVA8_DEFAULT_MODULARS];
	u_int32_t max_ntime; /* Maximum: 7200 */

	u_int8_t otp_info[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT][AVA8_OTP_LEN + 1];

	int mod_type[AVA8_DEFAULT_MODULARS];
	u_int8_t miner_count[AVA8_DEFAULT_MODULARS];
	u_int8_t asic_count[AVA8_DEFAULT_MODULARS];

	u_int32_t freq_mode[AVA8_DEFAULT_MODULARS];
	...
	u_int32_t core_volt[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT] \
			  [AVA8_DEFAULT_ASIC_MAX][AVA8_DEFAULT_CORE_VOLT_CNT];

	u_int8_t cutoff[AVA8_DEFAULT_MODULARS];
	...
	u_int32_t set_frequency[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT][AVA8_DEFAULT_PLL_CNT];
	u_int32_t get_frequency[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT][AVA8_DEFAULT_ASIC_MAX][AVA8_DEFAULT_PLL_CNT];

	int set_asic_otp[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT];

	u_int16_t get_voltage[AVA8_DEFAULT_MODULARS][1]; /* Output is the same */
	u_int32_t get_pll[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT][AVA8_DEFAULT_PLL_CNT];

	u_int32_t get_asic[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT][AVA8_DEFAULT_ASIC_MAX][6];
	...
	u_int32_t error_code[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT + 1];
	u_int32_t error_crc[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT];
	u_int8_t error_polling_cnt[AVA8_DEFAULT_MODULARS];

	uint64_t diff1[AVA8_DEFAULT_MODULARS];

	u_int16_t vin_adc_ratio[AVA8_DEFAULT_MODULARS];
	u_int16_t vout_adc_ratio[AVA8_DEFAULT_MODULARS];

	u_int16_t power_info[AVA8_DEFAULT_POWER_INFO_CNT];
...
struct avalon8_dev_description {
	...
	int mod_type;
	u_int8_t miner_count; /* it should not greater than AVA8_DEFAULT_MINER_CNT */
	u_int8_t asic_count; /* asic count each miner, it should not great than AVA8_DEFAULT_ASIC_MAX */
	u_int16_t vin_adc_ratio;
	u_int16_t vout_adc_ratio;
	int set_voltage_level;
	u_int16_t set_freq[AVA8_DEFAULT_PLL_CNT];
	int set_asic_otp;
};
...
extern u_int32_t opt_avalon8_th_pass;
extern u_int32_t opt_avalon8_th_fail;
extern u_int32_t opt_avalon8_th_init;
extern u_int32_t opt_avalon8_th_ms;
extern u_int32_t opt_avalon8_th_timeout;
extern u_int32_t opt_avalon8_th_add;
extern u_int32_t opt_avalon8_nonce_mask;
extern u_int32_t opt_avalon8_nonce_check;
extern u_int32_t opt_avalon8_mux_l2h;
extern u_int32_t opt_avalon8_mux_h2l;
extern u_int32_t opt_avalon8_h2ltime0_spd;
extern u_int32_t opt_avalon8_roll_enable;
extern u_int32_t opt_avalon8_spdlow;
extern u_int32_t opt_avalon8_spdhigh;
extern u_int32_t opt_avalon8_pid_p;
extern u_int32_t opt_avalon8_pid_i;
extern u_int32_t opt_avalon8_pid_d;

#endif /* DRIVER_AVALON_8_H */
